...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_JZ_MAC_CLK_25MHZ),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_JZ_MAC_CLK
	$(call KCONFIG_ENABLE_OPT,CONFIG_JZ_MAC_CLK_25MHZ)
endef
endif

ifeq ($(BR2_PACKAGE_THINGINO_KOPT_JZ_MAC_CLK_50MHZ),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_JZ_MAC_CLK
	$(call KCONFIG_ENABLE_OPT,CONFIG_JZ_MAC_CLK_50MHZ)
endef
endif
...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_LEDS),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_LEDS
	$(call KCONFIG_ENABLE_OPT,CONFIG_NEW_LEDS)
	$(call KCONFIG_ENABLE_OPT,CONFIG_LEDS_CLASS)
	$(call KCONFIG_ENABLE_OPT,CONFIG_LEDS_GPIO)
	$(call KCONFIG_ENABLE_OPT,CONFIG_LEDS_TRIGGERS)
	$(call KCONFIG_ENABLE_OPT,CONFIG_LEDS_TRIGGER_TIMER)
endef
endif
...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_EXTFS),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_EXTFS
	$(call KCONFIG_ENABLE_OPT,CONFIG_EXT4_FS)
	$(call KCONFIG_ENABLE_OPT,CONFIG_EXT4_USE_FOR_EXT23)
	$(call KCONFIG_ENABLE_OPT,CONFIG_EXT4_FS_POSIX_ACL)
	$(call KCONFIG_ENABLE_OPT,CONFIG_LBDAF)
endef
endif
...
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_GADGET_WEBCAM
	...
	$(call KCONFIG_SET_OPT,CONFIG_VIDEO_V4L2,m)
	$(call KCONFIG_SET_OPT,CONFIG_VIDEOBUF2_CORE,m)
	$(call KCONFIG_SET_OPT,CONFIG_VIDEOBUF2_MEMOPS,m)
	$(call KCONFIG_SET_OPT,CONFIG_VIDEOBUF2_VMALLOC,m)
	$(call KCONFIG_SET_OPT,CONFIG_USB_G_WEBCAM,m)
endef
else
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_GADGET_WEBCAM
	$(call KCONFIG_ENABLE_OPT,CONFIG_VIDEOBUF2_VMALLOC)
	$(call KCONFIG_SET_OPT,CONFIG_USB_G_WEBCAM,m)
endef
endif
endif
...
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS
	...
	$(call THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC1_PA_4BIT)
